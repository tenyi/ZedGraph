...
namespace ZedGraph
{
	...
	#region Serialization
		...
		public override void GetObjectData( SerializationInfo info, StreamingContext context )
		{
			...
			// B6-A-3 (C5 fix): 反序列化端第 114 行讀 info.GetInt32("schema3")，
			// 寫端原本用 "schema2" 鍵——父類 PointPair 也用 "schema2"，鍵覆蓋同槽
			// 但子 ctor 期望的 "schema3" 永遠讀不到 → SerializationException。
			// 改為與讀端對齊的 "schema3"，並讓值來源為自身的 schema3 常數。
